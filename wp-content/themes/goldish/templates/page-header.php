...
<?php echo ideapark_wrap( trim( ob_get_clean() ), '<header class="l-section c-page-header' . ( $header_class_add ? ' c-page-header--' . esc_attr( $header_class_add ) : '' ) . ( $with_subcategories ? ' c-page-header--sub-cat' : '' ) . '">', '</header>' ); ?>
