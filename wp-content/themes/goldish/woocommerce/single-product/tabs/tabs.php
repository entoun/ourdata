	...
	<div class="c-product__tabs">
		<div class="c-product__tabs-list js-tabs-list">
			...
			<?php foreach ( $product_tabs as $key => $product_tab ) { ?>
				<div class="c-product__tabs-item <?php echo esc_attr( $key ); ?>_tab <?php if ( $expand_first_tab && ! $index ) { ?> active<?php } ?>">
					<a onclick="return false" class="c-product__tabs-item-link js-tabs-item-link" href="#tab-<?php echo esc_attr( $key ); ?>">
