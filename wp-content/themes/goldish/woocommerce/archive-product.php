...
<div
	class="l-section<?php if ( ideapark_mod( 'product_grid_width' ) == 'boxed' ) { ?> l-section--container<?php } else { ?> l-section--container-wide<?php } ?> l-section--top-margin l-section--bottom-margin<?php if ( $with_sidebar ) { ?> l-section--with-sidebar<?php } ?>">
	<?php if ( $with_sidebar || $with_filter_mobile || $with_filter_desktop ) { ?>
		<div class="l-section__sidebar l-section__sidebar--<?php echo ideapark_mod( 'product_grid_width' ); ?> ">
			<?php
			/**
