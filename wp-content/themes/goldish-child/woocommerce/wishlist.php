					...
					<td class="c-wishlist__shop-td c-wishlist__shop-td--product-thumbnail">
						<?php if ( ! ideapark_wishlist()->view_mode() ) { ?>
							<a href="" onclick="return false;"
							   ...
							   title="<?php esc_attr_e( 'Remove', 'goldish' ); ?>" type="button">
...
<?php } ?>
	...
	<div
		...
		<h1 class="c-cart-empty__header"><?php esc_html_e( 'Your wishlist is currently empty', 'goldish' ); ?></h1>
		<p class="c-cart-empty__note"><?php printf( esc_html__( 'Click the %s icons to add products', 'goldish' ), '<i class="ip-wishlist c-cart-empty__wishlist"></i>' ); ?></p>
