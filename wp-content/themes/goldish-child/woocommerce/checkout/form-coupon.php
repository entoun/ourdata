...
<div class="c-cart__coupon">
	...
	<div class="c-cart__coupon-from-wrap">
		<div class="c-cart__coupon-form">
			...
			<button class="c-button--outline c-cart__coupon-apply c-button" id="ip-checkout-apply-coupon" name="apply_coupon" type="button"><?php esc_html_e( 'Apply', 'goldish' ); ?></button>
		</div>
	</div>
