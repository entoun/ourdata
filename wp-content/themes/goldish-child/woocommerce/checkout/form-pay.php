			...
			<div
				...
				<div id="payment">
					...
					<div class="c-cart__place-order form-row">
						...
						<?php echo apply_filters( 'woocommerce_pay_order_button_html', '<button type="submit" class="c-button c-button--full c-button--large c-button--accent c-cart__place-order-btn button alt" id="place_order" value="' . esc_attr( $order_button_text ) . '" data-value="' . esc_attr( $order_button_text ) . '">' . esc_html( $order_button_text ) . '</button>' ); // @codingStandardsIgnoreLine ?>
