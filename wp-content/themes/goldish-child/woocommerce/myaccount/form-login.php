	...
	<div class="c-login__form js-login-form c-login__form--active">
		...
		<form class="c-form" method="post">
			...
			<div class="c-form__row c-form__row--inline c-login__remember">
				...
				<label class="c-login__label">
					<input class="c-form__checkbox" name="rememberme" type="checkbox" id="rememberme" value="forever" /> &nbsp;<?php esc_html_e( 'Remember me', 'woocommerce' ); ?>
				</label>
			...
			<div class="c-form__row c-login__login-row">
				<button type="submit" class="c-button c-button--accent c-button--large c-button--full" name="login" value="<?php esc_attr_e( 'Log in', 'woocommerce' ); ?>"><?php esc_html_e( 'Log in', 'woocommerce' ); ?></button>
			</div>

			<?php if ( get_option( 'woocommerce_enable_myaccount_registration' ) === 'yes' ) { ?>
			<div class="c-login__bottom">
				<?php esc_html_e('Not a Member?', 'goldish'); ?>
				<a href="" onclick="return false;" class="c-login__register js-login-form-toggle"><?php esc_html_e( 'Register', 'woocommerce' ); ?></a>
			</div>
			<?php } ?>
	...
	<?php if ( get_option( 'woocommerce_enable_myaccount_registration' ) === 'yes' ) { ?>
		...
		<div class="c-login__form js-register-form">
			...
			<form method="post" class="c-form" <?php do_action( 'woocommerce_register_form_tag' ); ?>>
				...
				<div class="c-form__row">
					<label class="c-form__label" for="reg_username"><?php esc_html_e( 'Email address', 'woocommerce' ); ?>
						<span class="required">*</span></label>
				...
				<?php if ( 'no' === get_option( 'woocommerce_registration_generate_password' ) ) : ?>
					...
					<div class="c-form__row">
						<input type="password" placeholder="<?php esc_attr_e( 'Password', 'woocommerce' ); ?>" class="c-form__input c-form__input--full c-form__input--fill woocommerce-Input woocommerce-Input--text input-text" name="password" id="reg_password" autocomplete="new-password" />
					</div>

				<?php else : ?>

					<div class="c-form__row c-login__sent"><?php esc_html_e( 'A link to set a new password will be sent to your email address.', 'woocommerce' ); ?></div>
				...
				<div class="c-form__row c-login__register-row">
					...
					<button type="submit" class="c-button c-button--accent c-button--large c-button--full" name="register" value="<?php esc_attr_e( 'Register', 'woocommerce' ); ?>"><?php esc_html_e( 'Register', 'woocommerce' ); ?></button>
				</div>

				<div class="c-login__bottom">
					<?php esc_html_e('You a Member?', 'goldish'); ?>
					<a href="" onclick="return false;" class="c-login__register js-login-form-toggle"><?php esc_html_e( 'Login', 'woocommerce' ); ?></a>
				</div>
