    ...
    function init_form_fields() {
        ...
        $this->form_fields = array(
            ...
            'subject' => array(
                ...
                'type' 			=> 'text',
                'description' 	=> sprintf( __( 'This controls the email subject line. Variables: Site Title - %1s,  Order Number - %2s Order date - %3s. Leave blank to use the default subject: %4s.', 'custom-order-statuses-for-woocommerce' ), '{site_title}', '{order_number}', '{order_date}', $this->get_default_subject() ),
            ...
            'heading' => array(
                ...
                'type' 			=> 'text',
                'description' 	=> sprintf( __( 'This controls the main heading contained within the email notification. Variables: Site Title - %1s, Order Number - %2s, Order date - %3s. Leave blank to use the default heading: %4s.', 'custom-order-statuses-for-woocommerce' ),'{site_title}', '{order_number}', '{order_date}',   $this->heading ),
