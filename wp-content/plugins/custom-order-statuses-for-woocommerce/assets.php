...
function woocos_load_custom_settings_assets() {
    ...
    // Settings styles
    wp_enqueue_style('woocos-settings-style',  $plugin_location . 'assets/css/settings-page.css', array(), '394f15a65b28ca');

    // Settings scripts
    wp_enqueue_script('woocos-settings-script', $plugin_location . 'assets/js/settings-page.js', array(), '394f15a65b28cb');
...
function woocos_load_deactivation_assets() {
    ...
    // Deactivation styles
    wp_enqueue_style('woocos-deactivation-style',  $plugin_location . 'assets/css/deactivation.css', array(), '394f15a65b28cb');
    // Deactivation scripts
    wp_enqueue_script('woocos-deactivation-script', $plugin_location . 'assets/js/deactivation.js', array(), '394f15a65b28cf');
