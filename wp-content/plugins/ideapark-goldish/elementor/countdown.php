...
class Ideapark_Elementor_Countdown extends Widget_Base {
	...
	public function get_title() {
		return __( 'Goldish Countdown', 'ideapark-goldish' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_title',
			[
				'label' => __( 'Countdown', 'ideapark-goldish' ),
			]
		);
		...
		$this->add_control(
			'date',
			[
				'label'          => __( 'Event date', 'ideapark-goldish' ),
		...
		$this->add_control(
			'weeks',
			[
				'label'        => __( 'Show weeks', 'ideapark-goldish' ),
		...
		$this->add_control(
			'months',
			[
				'label'        => __( 'Show months', 'ideapark-goldish' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => __( 'Show', 'ideapark-goldish' ),
				'label_off'    => __( 'Hide', 'ideapark-goldish' ),
				'return_value' => 'yes',
		...
		$this->add_responsive_control(
			'space',
			[
				'label'      => __( 'Margins', 'ideapark-goldish' ),
	...
	protected function render() {
		...
		<script>
			var
				ideapark_countdown_months = '<?php echo esc_attr__( 'Months', 'ideapark-goldish' ); ?>',
				ideapark_countdown_weeks = '<?php echo esc_attr__( 'Weeks', 'ideapark-goldish' ); ?>',
				ideapark_countdown_days = '<?php echo esc_attr__( 'Days', 'ideapark-goldish' ); ?>',
				ideapark_countdown_hours = '<?php echo esc_attr__( 'Hours', 'ideapark-goldish' ); ?>',
				ideapark_countdown_minutes = '<?php echo esc_attr__( 'Minutes', 'ideapark-goldish' ); ?>',
				ideapark_countdown_seconds = '<?php echo esc_attr__( 'Seconds', 'ideapark-goldish' ); ?>';
		</script>
