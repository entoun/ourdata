...
class Ideapark_Elementor_Icon_List_1 extends Widget_Base {
	...
	public function get_title() {
		return __( 'Advantages', 'ideapark-goldish' );
	}
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			'item_space',
			[
				'label'     => __( 'Item space', 'ideapark-goldish' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'space-evenly',
				'options'   => [
					'space-evenly'  => __( 'Evenly', 'ideapark-goldish' ),
					'space-around'  => __( 'Around', 'ideapark-goldish' ),
					'space-between' => __( 'Between', 'ideapark-goldish' ),
				],
				'selectors' => [
		...
		$this->add_control(
			'icon_color',
			[
				'label'     => __( 'Icon Color', 'ideapark-goldish' ),
		...
		$this->start_controls_section(
			'section_icon_list',
			[
				'label' => __( 'Item List', 'ideapark-goldish' ),
			]
		);
		...
		$repeater->add_control(
			...
			[
				...
				'label_block' => true,
				'default'     => __( 'List Item', 'ideapark-goldish' ),
		...
		$this->add_control(
			...
			[
				...
				'default'     => [
					[
						'title'    => __( 'List Item #1', 'ideapark-goldish' ),
						'icon_svg' => 'fa fa-dot-circle-o',
						'link'     => '#'
					],
					[
						'title'    => __( 'List Item #2', 'ideapark-goldish' ),
						'icon_svg' => 'fa fa-dot-circle-o',
						'link'     => '#'
					],
					[
						'title'    => __( 'List Item #3', 'ideapark-goldish' ),
						'icon_svg' => 'fa fa-dot-circle-o',
						'link'     => '#'
					],
				],
