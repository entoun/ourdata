...
class Ideapark_Elementor_Slider extends Widget_Base {
	...
	protected function render() {
		...
		?>
		<div
			class="c-ip-slider <?php if ( $settings['fixed_height'] == 'yes' ) { ?> c-ip-slider--fixed-height<?php } ?><?php if ( $settings['layout'] == 'boxed' ) { ?> l-section__container<?php } ?> c-ip-slider--<?php echo ideapark_mod( 'header_type' ); ?> c-ip-slider--<?php echo $settings['layout']; ?> js-slider">
			<div
				...
				<?php foreach ( $settings['slider_list'] as $index => $item ) { ?>
					...
					<div
						...
						?>
						<div class="c-ip-slider__wrap c-ip-slider__wrap--<?php echo $settings['layout']; ?> <?php if ($settings['layout'] == 'layout-1') { ?>c-ip-slider__wrap--<?php echo $settings['vertical_align']; ?><?php } ?>">
