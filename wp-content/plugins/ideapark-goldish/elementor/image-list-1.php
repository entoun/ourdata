...
class Ideapark_Elementor_Image_List_1 extends Widget_Base {
	...
	protected function register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => __( 'Image list settings', 'ideapark-goldish' ),
			]
		);
		$this->add_control(
			'layout',
	...
	protected function render() {
		...
		?>
		<div class="c-ip-image-list-1 c-ip-image-list-1--<?php echo $settings['layout']; ?><?php if ( $settings['layout'] == 'carousel' && $settings['arrows'] == 'yes' ) { ?> c-ip-image-list-1--nav<?php } ?><?php if ( $settings['layout'] == 'carousel' && $settings['dots'] == 'yes' ) { ?> c-ip-image-list-1--dots<?php } ?>">
			<div class="c-ip-image-list-1__wrap c-ip-image-list-1__wrap--<?php echo $settings['layout']; ?>">
				<div class="c-ip-image-list-1__list c-ip-image-list-1__list--<?php echo $settings['layout']; ?> <?php if ( $settings['layout'] == 'carousel' ) { ?> js-image-list-1 h-carousel <?php if ( $settings['layout'] == 'carousel' && $settings['dots'] == 'yes' ) { ?> h-carousel--default-dots<?php } else { ?> h-carousel--dots-hide<?php } ?> <?php if ( $settings['arrows'] != 'yes' ) { ?>h-carousel--nav-hide<?php } else { ?>h-carousel--hover h-carousel--round h-carousel--outline h-carousel--tr h-carousel--border<?php } ?><?php } ?>">
					<?php
					foreach ( $settings['icon_list'] as $index => $item ) : ?>
						<div class="c-ip-image-list-1__item c-ip-image-list-1__item--<?php echo $settings['layout']; ?><?php ideapark_class( $settings['zoom'], 'c-ip-image-list-1__item--zoom', '' ); ?>">
							<?php
