...
class Ideapark_Elementor_Video extends Widget_Base {
	...
	public function get_title() {
		return __( 'Video Button', 'ideapark-goldish' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'video_url',
			[
				'label'       => __( 'Video URL', 'ideapark-goldish' ),
				'description' => __( 'Link to Vimeo or YouTube video.', 'ideapark-goldish' ),
				'type'        => Controls_Manager::TEXT,
				'dynamic'     => [
					'active' => true,
				],
				'placeholder' => __( 'https://link-to-the-video.com', 'ideapark-goldish' ),
			]
		);
