...
$home_page_id   = ( $page = get_page_by_title( 'Home 5' ) ) ? $page->ID : 0;

$mods                            = [];
$mods['switch_image_on_hover']   = true;
$mods['product_buttons_layout']  = 'buttons-2';
$mods['accent_color']            = $mods['featured_badge_text'] = $mods['new_badge_color'] = '#24823E';
...
$theme_home = [
	...
	'url'        => 'https://parkofideas.com/goldish/demo1/home-5/',
	'mods'       => $mods,
	'options'    => $options,
];